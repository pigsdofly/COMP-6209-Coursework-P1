...
struct RECTUNROLL {
    static constexpr double eval(double div, double lower) {
...
template <class P, int COUNT>
struct RECT {
    static constexpr double eval(double lower, double higher) {
...
template <class RULE>
struct INTEGRATE {
    static constexpr double integrate(double lower, double higher) {
